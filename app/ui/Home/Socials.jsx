...
export default function Socials() {
    ...
    return (
        <div className="w-full bg-[--accent-100] text-[--bg-100] py-4 px-3 flex flex-col items-center lg:flex-row justify-center relative lg:justify-end">
            <div className="pictures lg:flex lg:w-[450px] lg:justify-center lg:items-center lg:absolute lg:left-4 bottom-0 xl:left-12 2xl:left-[8rem]">
                <Image src="/chocolate-cookies.png" alt="cookies" width="250" height="250" className="w-auto hidden lg:block [filter:_drop-shadow(2px_2px_2px_#ffffff)]" />
                <Image src="/chocolate-cookies.png" alt="cookies" width="200" height="200" className="w-auto block lg:hidden [filter:_drop-shadow(2px_2px_2px_#ffffff)]" />
            </div>
